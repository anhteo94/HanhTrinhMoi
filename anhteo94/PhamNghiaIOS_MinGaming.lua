...
Window:ChangeBackground("https://raw.githubusercontent.com/anhteo94/HanhTrinhMoi/main/background_anh.png")
...
Window:Init(function()
    ...
    s1:NewToggle("Auto Tộc V4", "Tự động far mobs Tộc V4", function(v)
        _G.AutoTocV4 = v
    end)
